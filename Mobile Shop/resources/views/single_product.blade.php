...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="card img">
                <img src="{{ URL :: to($mobile -> item_image) }}" class="alignment">
            </div>
        </div>
        <div class="col-md-6 align">
            <h4 class="book-name">{{ $mobile -> brand_name }}</h4>
            <h5>Category : <span class="category">{{ $mobile -> category_name }}</span></h5>
            <h5>Price : <span class="bolder">Tk. {{ $mobile -> item_price }}</span></h5>
