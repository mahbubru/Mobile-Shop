                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="card" style="width: 15rem;">
                            <img src="{{ URL :: to($mobile -> item_image) }}" class="card-inside">
                            <div class="book-info">
                                <h5>{{ $mobile -> brand_name }}</h5>
                                <h6><span class="price">Tk. {{ $mobile -> item_price }}</span></h6>

                            </div>
                            <a class="btn btn-outline-success" href="{{ URL :: to('/show-product/'.$mobile -> menu_id) }}">View details</a>
